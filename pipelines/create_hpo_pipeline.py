...
def hpo_pipeline(
    ...
    parameter_spec = serialize_parameters({
        "pca_n":                hpt.DiscreteParameterSpec([128, 192, 256], scale="linear"),
        "xgb_max_depth":        hpt.IntegerParameterSpec(5, 7, "linear"),
        "xgb_min_child_weight": hpt.IntegerParameterSpec(1, 3, "linear"),
        "xgb_subsample":        hpt.DoubleParameterSpec(0.85, 0.95, "linear"),
        "logreg_c":             hpt.DoubleParameterSpec(0.08, 0.12, "log"),
        "blend_weight":         hpt.DoubleParameterSpec(0.55, 0.65, "linear"),
        "learning_rate":        hpt.DoubleParameterSpec(0.015, 0.025, "log"),
        "gamma":                hpt.DoubleParameterSpec(0.05, 0.15, "linear"),
        "colsample_bytree":     hpt.DoubleParameterSpec(0.85, 0.95, "linear"),
        "scale_pos_weight":     hpt.DoubleParameterSpec(5.0, 15.0, "log"),
        "alpha":                hpt.DoubleParameterSpec(1e-5, 0.05, "log"),
        "reg_lambda":           hpt.DoubleParameterSpec(1e-5, 0.05, "log"),
        "use_smote":            hpt.CategoricalParameterSpec(['true', 'false']),
    })
